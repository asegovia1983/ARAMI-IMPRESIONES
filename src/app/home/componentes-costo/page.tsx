...
export default function ComponentesCostoPage() {
  ...
  // Form: igual a ComponenteCosto pero con costoUnit en string para el input
  type Form = Omit<ComponenteCosto, "costoUnit"> & { costoUnit: string };
    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          />
          <button className="bg-black text-white px-4 py-2 rounded" onClick={onNew}>
            Nuevo
          </button>
        </div>
      </div>
            ...
            {filtered.map((c) => (
              <tr key={c.id} className="border-b dark:border-gray-700">
                ...
                <td className="p-3 text-right space-x-2">
                  ...
                  <button className="underline text-red-600" onClick={() => onDelete(c.id)}>
                    Eliminar
                  </button>
                </td>
              </tr>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    value={form.tipo}
                    onChange={(e) =>
                      setForm((f) => ({ ...f, tipo: e.target.value as TipoComponente }))
                    }
                  >
